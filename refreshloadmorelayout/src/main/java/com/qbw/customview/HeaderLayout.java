...
class HeaderLayout extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        img_refresh = (ImageView)view.findViewById(R.id.imageView_refresh);
        img_refresh.setBackgroundResource(R.drawable.refresh_list);
        refreshAnimation = (AnimationDrawable)img_refresh.getBackground();
