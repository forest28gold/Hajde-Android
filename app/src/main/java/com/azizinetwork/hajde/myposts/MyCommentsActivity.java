...
public class MyCommentsActivity extends AppCompatActivity implements RefreshLoadMoreLayout.CallBack {

    private final static String TAG = "MyCommentsActivity";
    ...
    public void initLoadMyCommentsData() {
...
//        String whereClause = String.format("%s LIKE '%%s%'", Global.KEY_COMMENT_TYPE, Global.g_userInfo.getUserID());
        String whereClause = Global.KEY_COMMENT_TYPE + " LIKE '%" + Global.g_userInfo.getUserID() + "%'";
                ...
                new AsyncCallback<BackendlessCollection<Post>>(){
                    ...
                    public void handleResponse( BackendlessCollection<Post> postBackendlessCollection )
                    {
                        ...
                        if (postBackendlessCollection.getData().size() > 0) {
                            ...
                            if (Global.g_userInfo.getCommentCount() < tempCount) {
                                Global.g_userInfo.setCommentCount(tempCount);
